...
const UPDATE_COMMENT = gql`
  mutation UpdateComment($body: String!, $slug: String!, $comment_id: Int!, $status: String!) {
...
const DELETE_COMMENT = gql`
  mutation DeleteComment($body: String!, $slug: String!, $comment_id: Int!, $status: String!) {
