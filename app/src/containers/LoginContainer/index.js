...
class LoginContainer extends Component {
  ...
  componentDidMount() {
    const storedToken =
      window.location.href.match(/\?verify_token=(.*)/) &&
      ...
      >
        ...
        {this.state.forgotPasswordModal == true && (
          ...
          >
            ...
            <Paragraph>
              Type in the email associated with your account. We will send you
              an email with a link you can use to reset your password.
            </Paragraph>
            <FormFields>
              <FormField
                label="Email Address *"
        ...
        {this.state.loggedInToast == true && (
          <Toast
            status="ok"
            onClose={() => browserHistory.push(`/admin/dashboard`)}
          >
        ...
        {this.state.notificationToast && (
          <Toast
            status="critical"
            onClose={() => this.toggleNotificationToast()}
          >
