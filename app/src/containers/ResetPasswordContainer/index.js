        ...
        <div>
          <MainBox alignContent="center" fill="horizontal" align="center">
            <FullSection primary direction="row">
              <Section align="center" justify="center" className="loading__box">
        ...
        >
          <Box className={styles.loginForm} pad={{ horizontal: "large" }}>
            ...
            {currentUser != null ? (
              ...
              <Paragraph>
                This password reset token is invalid. If you still cannot
                remember your password, please{" "}
                <Anchor to="/login">request another token</Anchor>.
              </Paragraph>
            )}
          </Box>
        </Box>
...
export default compose(
  ...
  graphql(VERIFY_USER, {
    name: "verifyUser",
    options: params => ({ variables: { token: props.params.id } })
  })
