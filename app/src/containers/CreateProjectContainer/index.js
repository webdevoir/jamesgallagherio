    ...
    return (
      ...
      >
        ...
        >
          ...
          <Divider />
          <Box className={styles.loginForm} pad={{ horizontal: "large" }}>
            <Box align="center" justify="center">
              <img style={{ maxWidth: 150, height: "auto" }} />
            </Box>
            <FormFields className={styles.formFields}>
              <Section pad={{ vertical: "medium" }} align="left" justify="left">
                <Label align="left">Project Information</Label>
                <FormField
                ...
                <FormField
                  ...
                  className={styles.formField}
                  error={
                    this.state.caption_field ? this.state.caption_field : ""
                  }
                >
                  <input
                    required
                ...
                <FormField
                  label="Category *"
                  help="What is the project's category?"
                  className={styles.formField}
                  error={
                    this.state.category_field ? this.state.category_field : ""
                  }
                >
                  <Select
                    required
                    ...
                    onChange={event =>
                      this.setState({ category: event.option })
                    }
                  />
                </FormField>
                <FormField
                  ...
                  className={styles.formField}
                  error={
                    this.state.repository_url_field
                      ? this.state.repository_url_field
                      : ""
                  }
                >
                  <input
                    ...
                    type="text"
                    onChange={e =>
                      this.setState({ repository_url: e.target.value })
                    }
                    className={styles.input}
                  />
                </FormField>
              ...
              <Section pad={{ vertical: "medium" }} align="left" justify="left">
                <Label align="left">Milestones</Label>
                <FormField
                ...
                >
                  <textarea
                    ...
                    type="text"
                    onChange={e =>
                      this.setState({ milestones: e.target.value })
                    }
                    className={styles.input}
                  />
                </FormField>
              ...
              <Section pad={{ vertical: "medium" }} align="left" justify="left">
                ...
                <FormField
                  ...
                  className={styles.formField}
                  error={
                    this.state.feature_image_field
                      ? this.state.feature_image_field
                      : ""
                  }
                >
                  <input
                    ...
                    type="text"
                    onChange={e =>
                      this.setState({ feature_image: e.target.value })
                    }
                    className={styles.input}
                  />
                </FormField>
              ...
              <Section pad={{ vertical: "medium" }} align="left" justify="left">
                <Label align="left">Technical Information</Label>
                <FormField
                  ...
                  className={styles.formField}
                  error={
                    this.state.technical_information_field
                      ? this.state.technical_information_field
                      : ""
                  }
                >
                  <textarea
                    ...
                    type="text"
                    onChange={e =>
                      this.setState({ technical_information: e.target.value })
                    }
                    className={styles.input}
                  />
                </FormField>
            ...
            {this.state.projectImageCreated == true && (
              <Toast
                status="ok"
                onClose={() => this.toggleProjectImageCreated()}
              >
            ...
            {this.state.projectImageDeleted == true && (
              <Toast
                status="ok"
                onClose={() => this.toggleProjectImageDeleted()}
              >
...
export default compose(
  ...
  graphql(FEED_PROJECT, {
    name: "getProject",
    options: props => ({ variables: { slug: qs.parse(location.search).slug } })
  }),
