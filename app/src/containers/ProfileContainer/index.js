...
>
   ...
   <Section pad={{ vertical: 'medium' }} align="center" justify="center">
     ...
     <Section pad={{ vertical: 'medium' }} align="center" justify="center">
       ...
       <FormField
         ...
         className={styles.formField}
         error={this.state.profile_picture_field ? this.state.profile_picture_field : ""}
       >
         <input
           required
           id="profile_picture"
   ...
   <Section pad={{ vertical: 'medium' }} align="center" justify="center">
     ...
     >
       <input
         ...
         id="bio"
         name="bio"
         placeholder={`I am ${currentUser.name}, full-stack web dev and lover of cats!`}
         type="text"
 ...
 <Section pad={{ vertical: 'medium' }} align="center" justify="center">
  ...
  _updateAccount = async function() {
    ...
    this.setState({ name_field: "", email_field: "", bio_field: "", profile_picture_field: "" })
...
const UPDATE_USER = gql`
  mutation UpdateUser($name: String!, $email: String!, $profile_picture: String!, $bio: String!) {
    updateUser(name: $name, email: $email, profile_picture: $profile_picture, bio: $bio) {
      id
    }
  }
`;
...
export default compose(
  ...
  graphql(CURRENT_USER, { name: 'getUser' })) (ProfileContainer);
