...
class BlogPostContainer extends Component {
  ...
  render() {
    ...
    if (
      this.props.getMainPostUpvotes &&
      this.props.getMainPostUpvotes.loading
    ) {
      return (
        <div>
          <LoadingIndicator isLoading />
    ...
    return (
      <div className={styles.page}>
        <Hero backgroundImage={post.feature_image} size="large">
        ...
        <Section className="container" primary>
          <Article align="center" justify="center" className="panel">
        ...
        <Section>
          <Box className="container">
            <Article className="panel markdown-body-blog" align="center">
              <Heading align="center">Tags</Heading>
              <Divider />
...
export default compose(
  ...
  graphql(FEED_POST_TAGS, {
    name: "getPostTags",
    options: props => ({ variables: { slug: props.params.slug } })
  }),
  graphql(CREATE_UPVOTE, { name: "createUpvote" }),
  graphql(FEED_POST_UPVOTES, {
    name: "getMainPostUpvotes",
    options: props => ({ variables: { slug: props.params.slug } })
  })
)(BlogPostContainer);
